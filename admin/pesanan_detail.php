...
// Ambil data order
$sql = "SELECT o.*, u.name as user_name, u.email FROM orders o JOIN users u ON o.user_id = u.id WHERE o.id = $order_id";
...
<head>
    ...
    <title>Detail Pesanan #<?php echo $order_id; ?> - Admin RentCamp</title>
...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-dark bg-success">
        <div class="container">
            ...
            <div class="d-flex">
                <a href="pesanan.php" class="btn btn-light me-2">Manajemen Pesanan</a>
    ...
    <div class="container py-5">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <p><b>User:</b> <?php echo htmlspecialchars($order['user_name']); ?> (<?php echo htmlspecialchars($order['email']); ?>)</p>
        ...
        <a href="pesanan.php" class="btn btn-secondary mt-4">Kembali ke Daftar Pesanan</a>
    </div>
</body>
</html> 